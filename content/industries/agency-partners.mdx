...
An agency deciding whether to bring the rest of its book under this arrangement has a real answer available: [what the first one or two accounts actually produced](/proof), reported the same way every other account on this site is.
