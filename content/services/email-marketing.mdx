...
<DefinitionList items={[
  { term: "Lifecycle segmentation", definition: "Sequence, cadence, and personalized content built around where a contact actually is in the customer journey - new lead, active customer, lapsed, VIP." },
